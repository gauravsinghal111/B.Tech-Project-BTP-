...
# 1. LOAD DATA
# ─────────────────────────────────────────────
train_raw = pd.read_csv("Training Set_E.csv")
test_raw  = pd.read_csv("Test Set_E.csv")
...
plt.suptitle("Model Comparison on Test Set (Experimental)", fontsize=14, fontweight="bold", y=1.01)
plt.tight_layout()
plt.savefig("E_01_model_comparison.png", dpi=150, bbox_inches="tight")
plt.close()
print("\nSaved: E_01_model_comparison.png")
...
ax.set_title("5-Fold Cross-Validation R² (Experimental Training Set)", fontweight="bold")
ax.set_ylabel("CV R²")
ax.set_xticklabels(model_names, rotation=35, ha="right", fontsize=9)
plt.tight_layout()
plt.savefig("E_02_cv_scores.png", dpi=150, bbox_inches="tight")
plt.close()
print("Saved: E_02_cv_scores.png")
...
plt.suptitle("Actual vs Predicted LD — All Models (Experimental)", fontsize=13, fontweight="bold", y=1.01)
plt.tight_layout()
plt.savefig("E_03_actual_vs_predicted_all.png", dpi=150, bbox_inches="tight")
plt.close()
print("Saved: E_03_actual_vs_predicted_all.png")
...
plt.tight_layout()
plt.savefig("E_04_best_model_detail.png", dpi=150, bbox_inches="tight")
plt.close()
print("Saved: E_04_best_model_detail.png")
...
for bar, val in zip(bars, sorted_vals):
    ax.text(bar.get_x() + bar.get_width()/2, bar.get_height() + 0.002,
            f"{val:.3f}", ha="center", va="bottom", fontsize=8)
plt.tight_layout()
plt.savefig("E_05_feature_importance.png", dpi=150, bbox_inches="tight")
plt.close()
print("Saved: E_05_feature_importance.png")

# --- 7f. LD Distribution ---
fig, axes = plt.subplots(1, 2, figsize=(12, 4))
axes[0].hist(y_train, bins=40, color="#3498db", edgecolor="white", alpha=0.85)
axes[0].set_title("LD Distribution — Experimental Training Set", fontweight="bold")
axes[0].set_xlabel("LD"); axes[0].set_ylabel("Count")

axes[1].hist(y_test, bins=25, color="#e67e22", edgecolor="white", alpha=0.85)
axes[1].set_title("LD Distribution — Experimental Test Set", fontweight="bold")
axes[1].set_xlabel("LD"); axes[1].set_ylabel("Count")

plt.tight_layout()
plt.savefig("E_06_ld_distribution.png", dpi=150, bbox_inches="tight")
plt.close()
print("Saved: E_06_ld_distribution.png")
...
ax.set_title("Pearson Correlation Heatmap (Experimental Training Set)", fontweight="bold")
plt.tight_layout()
plt.savefig("E_07_correlation_heatmap.png", dpi=150, bbox_inches="tight")
plt.close()
print("Saved: E_07_correlation_heatmap.png")
...
ax.legend(fontsize=9)
plt.tight_layout()
plt.savefig("E_08_parity_plot.png", dpi=150, bbox_inches="tight")
plt.close()
print("Saved: E_08_parity_plot.png")
...
summary_df.to_csv("E_model_results_summary.csv", index=False)
print("\nSaved: E_model_results_summary.csv")
...
pred_df.to_csv("E_test_predictions.csv", index=False)
print("Saved: E_test_predictions.csv")
